...
doc = fitz.open()
cal = calendar.LocaleTextCalendar(locale="cs_CZ.UTF-8")   # choose your locale
# get sizes for A4 landscape paper
w, h = fitz.PaperSize("a4-l")

txt = cal.formatyear(startyear, m=4)
doc.insertPage(-1, txt, fontsize=11,
               fontname="Times-Roman", width=w, height=h)
...
doc.save("export/Kalender.pdf", garbage=4, deflate=True)
